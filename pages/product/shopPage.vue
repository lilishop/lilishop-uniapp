	...
	<view>
		...
		<div>
			...
			<div class="wrapper">
				...
				<div class="store flex">
					...
					<div class="collection">
						<div class="collection-btn" @click="whetherCollection"> {{ isCollection  ? '已关注' : '+ 关注' }}
						</div>
					</div>
				</div>
				<!-- 店铺简介 -->
			...
			<div v-for="(item,index) in pageData.list" :key="index">
				...
				<u-navbar class="navbar" v-if="item.type == 'search'" 
	...
	export default {
		...
		methods: {
			...
			linkKefuDetail() {
				...
				uni.navigateTo({
					url: "/pages/product/customerservice/index?params=" +
